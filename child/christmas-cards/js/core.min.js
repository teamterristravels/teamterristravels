...
/**
 * @module       Snow
 * @author       Tiffany Rayside (@link https://codepen.io/tmrDevelops)
 * @license      MIT
 * @see          (@link https://codepen.io/tmrDevelops/pen/PPgjwz)
 */
function getSnow(t){var n,i=window.innerWidth,o=window.innerHeight,r=t.getContext("2d"),h=50,d=500,c=10,l=new Array,e=["#eee"];t.setAttribute("width",i),t.setAttribute("height",o),function(){for(var t=n=0;t<d;t++)l[t]={x:Math.ceil(Math.random()*i),y:Math.ceil(Math.random()*o),toX:5*Math.random()+1,toY:5*Math.random()+1,c:e[Math.floor(Math.random()*e.length)],size:2*Math.random()}}(),function t(){r.clearRect(0,0,i,o);for(var e=0;e<d;e++){var a=l[e];r.beginPath(),r.arc(a.x,a.y,a.size,0,2*Math.PI,!1),r.fillStyle=a.c,r.fill(),a.x=a.x+a.toX*(.05*n),a.y=a.y+a.toY*(.05*n),a.x>i&&(a.x=0),a.y>o&&(a.y=0),a.x<0&&(a.x=i),a.y<0&&(a.y=o)}n<c&&n++,timerID=setTimeout(t,1e3/h)}()}